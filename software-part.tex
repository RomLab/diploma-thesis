...
Každý termostat má dále zobrazení, zda je koncový snímač prostorové teploty připojen k centrální jednotce, ověření probíhá na základě posílaní aktuálního času, který se porovnává s časem v centrální jednotce zpožděný o~minutu, pokud zařízení neposílá aktuální čas, dojde ke zpoždění a zařízení se vyhodnotí jako nepřipojené. Dále je zde detekce otevřeného okna, tato funkce je více popsána v části \ref{sec:detekce-otevreneho-okna}. 
