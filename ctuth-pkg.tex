...
\cs_new:Nx \ctuthesis_geometry_hmarginratio: {1\string :1}

% Target textwidth is 33*basesize (10pt to 12pt)
\dim_const:Nn \g_ctuthesis_geometry_textwidth_dim { \tl_use:N \g_ctuthesis_fontsize_tl * 42 }
...
\ctuifswitch { layout-short } {
	...
	\cs_new:Nx \ctuthesis_geometry_vmarginratio: {1\string :1}
} {
	\dim_const:Nn \g_ctuthesis_geometry_textheight_dim { 0.8\paperheight }
	\cs_new:Nx \ctuthesis_geometry_vmarginratio: {1\string :1}
}
...
\cs_new_protected:Nn \ctuthesis_geometry_title: {
	\newgeometry {
		...
		textwidth = \dim_min:nn { 460pt } { 1.2 \g_ctuthesis_geometry_textwidth_dim } ,
	 	textheight = \g_ctuthesis_geometry_textheight_dim ,
