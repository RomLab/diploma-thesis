...
This thesis deals with a system for regulation of zone heating of every household. Proposed control system is based on Raspberry Pi with the Home Assistant system. The unit is fully controllable via web. Within the system was selected or made a device for controlling the individual parts of the heating zone control and local room temperature sensors.  The programmed system was eventually tested in real environment.
