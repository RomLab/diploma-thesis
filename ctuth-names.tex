...
\keys_define:nn { ctuthesis } {
	...
	xdoctype-SemPro .meta:n = {
		doctype-english = { Semestr ~ Project },
		doctype-czech = { Semestrální ~ projekt },
		doctype-slovak = { Semestrálne ~ projekt }
	},
	xdoctype-SemProJakoM .meta:n = {
		doctype-english = { Semestr ~ Project ~ as ~ background ~ for ~ Master ~ Thesis},
		doctype-czech = { Semestrální ~ projekt ~ jako ~ podklad ~ pro ~ diplomovou ~ práci},
		doctype-slovak = { Semestrálne ~ projekt ~ ako ~ podklad ~ pre ~ diplomovú ~ prácu}
	},
	xdoctype-B .meta:n = {
